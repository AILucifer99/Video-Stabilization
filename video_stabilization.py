...
# Read input video
cp = cv2.VideoCapture('./Resources/Sample.mp4')
...
# Try doing 2*width
out = cv2.VideoWriter('./video_out.mp4', 0x7634706d, fps, (2*width, height))
...
for i in range(n_frames-2):
	...
	# try fullAffine = True
	m = cv2.estimateRigidTransform(prev_pts, curr_pts, fullAffine=True) 
